...
class MainWindow(customtkinter.CTk):
    ...
    @safe_file_operation
    def open_product_extractor(self):
        """商品情報抽出ツールを起動する"""
        subprocess.Popen(['python', 'jan_weight_extractor_gui.py'])
    ...
    def setup_ui(self):
        ...
        buttons = [
            ...
            ("商品情報抽出ツール", self.open_product_extractor, 5, 0, "#FF6600"),
            ("クリップボードのクリア", clear_files,            6, 0, "#0078D4"),
