...
class MainWindow(customtkinter.CTk):
    ...
    def setup_ui(self):
        ...
        buttons = [
            ...
            ("JANコードコピーと座標軸", self.open_combined_form, 2, 0, "#FF0000"),  # 新しいボタン
    ...
    @safe_file_operation
    def open_combined_form(self):
        """統合されたJANコードと座標軸コピーフォームを開く"""
        subprocess.Popen(['python', 'combined_jan_coord.py'])
